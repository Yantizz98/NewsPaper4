...
from NewsPaper.Composition.models import Post, Category
...
def my_job():
    ...
    msg = EmailMultiAlternatives(
        ...
        body='Публикации за неделю в вашей любимой категории',
        from_email='yantizz@yandex.ru',
        to=subscribers
    )
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            my_job,
            trigger=CronTrigger(day_of_week="sun", hour="20", minute="47"),
